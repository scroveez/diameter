/* interbaseCreate.sql
-- create a simple SQL database for use by AuthSQL on Interbase
-- Requires the modified version of SqlDb.pm for Interbase
...
--
-- Note that, in contrast to mopst other SQLs, 
-- Interbase does not permit columns named PASSWORD
...
--
-- $Id: interbaseCreate.sql,v 1.11 2005/01/25 05:16:45 mikem Exp $
*/
...
create table SUBSCRIBERS (
	...
	PASS_WORD	varchar(50),	/* Cleartext password*/
...
create table ACCOUNTING (
	USERNAME	varchar(50) not null,	/* From User-Name */
