-- sqliteCreate.sql
-- create a simple SQL database for use by DBD::SQLite2
...
-- Indexes and dropping of indexes in SQLite 2 is not well supported
...
-- This table can be used in the example EAP-TTLS hook
