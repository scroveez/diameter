-- postgresCreate.sql
-- create a simple PostgreSQL database for use by AuthSQL
...
--
-- $Id: postgresCreate.sql,v 1.17 2005/01/25 05:16:54 mikem Exp $
...
-- in the config file.
-- The exact names of the columns and this table can be changed 
-- with the
-- config file, but the names given here are the defaults.
-- Note that some versions of postgreSQL dont permit a column 
-- with the name PASSWORD. You may have chage it to PASS_WORD, and you
-- will have to change your AuthSelect configuration parameter to suit.
create table SUBSCRIBERS (
	USERNAME	varchar(50) primary key,
	PASSWORD	varchar(50),
	ENCRYPTEDPASSWORD varchar(50),
	CHECKATTR	varchar(200),
	REPLYATTR	varchar(200)
);
